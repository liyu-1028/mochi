...
const zhCN: StringTable = {
  ...
  "settings.diagDone": "诊断包已导出（已脱敏）",
  "settings.exportDone": "设置已导出",
  "settings.importDone": "设置已导入并生效",
  "settings.ioFailed": "操作失败，请重试",
...
const en: StringTable = {
  ...
  "settings.diagDone": "Diagnostics exported (redacted)",
  "settings.exportDone": "Settings exported",
  "settings.importDone": "Settings imported",
  "settings.ioFailed": "Operation failed, please retry",
  "settings.languageZh": "简体中文",
  "settings.languageEn": "English",
